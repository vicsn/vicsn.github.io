(() => {
  ...
  const i18n = {
    en: {
      'nav.home':'Home','nav.how':'How it works','nav.profile':'My profile','nav.match':'My match','nav.admin':'Admin','nav.signin':'Demo sign in','nav.join':'Join Lunchclub',
    ...
    de: {
      'nav.home':'Start','nav.how':'So funktioniert’s','nav.profile':'Mein Profil','nav.match':'Mein Match','nav.admin':'Admin','nav.signin':'Demo-Anmeldung','nav.join':'Lunchclub beitreten',
